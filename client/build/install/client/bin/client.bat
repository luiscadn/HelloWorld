...
set DEFAULT_JVM_OPTS="-DIce.Config=$APP_HOME/config/config.client"
...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\common.jar;%APP_HOME%\lib\ice-3.7.10.jar
