...
set DEFAULT_JVM_OPTS="-DIce.Config=$APP_HOME/config/config.server"
...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\common.jar;%APP_HOME%\lib\ice-3.7.10.jar
